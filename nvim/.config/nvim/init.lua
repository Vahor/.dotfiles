...
-- center cd/cu
vim.keymap.set('n', 'cd', 'zz', { desc = 'Center cursor on [d]own' })
vim.keymap.set('n', 'cu', 'zz', { desc = 'Center cursor on [u]p' })
        ...
        handlers = {
          function(server_name)
            ...
            if server_name == 'jdtls' then
              -- already configured in the java.lua plugin
              return
            end
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      ...
      require('nvim-treesitter.configs').setup {
        ensure_installed = { 'bash', 'c', 'html', 'lua', 'markdown', 'vim', 'vimdoc', 'java', 'go' },
